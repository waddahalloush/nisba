...
import 'change_payment_password_controller.dart';

class ChangePaymentPasswordScreen
    extends GetView<ChangePaymentPasswordController> {
  const ChangePaymentPasswordScreen({super.key});
            ...
            children: [
              ...
              Obx(() {
                if (controller.selectedTab.value == 0) {
                  return _buildOldPasswordForm(theme);
                }
  ...
  Widget _buildOldPasswordForm(ThemeData theme) {
    final cs = theme.colorScheme;

    return Form(
      key: controller.formKeyOld,
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [
          _PasswordField(
            ...
            () => SizedBox(
              ...
              child: ElevatedButton(
                onPressed: controller.isSubmitting.value
                    ? null
                    : controller.changeWithOldPassword,
