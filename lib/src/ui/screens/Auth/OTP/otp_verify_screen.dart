                    ...
                    Obx(
                      () => RichText(
                        text: TextSpan(
                          ...
                          children: [
                            TextSpan(text: 'auth_resend_countdown_prefix'.tr),
                            TextSpan(
                            ...
                            TextSpan(text: 'auth_resend_countdown_suffix'.tr),
                          ],
                        ),
                      ),
                    ),
                ...
                Obx(
                  () => AppPrimaryButton(
                    ...
                    onPressed: controller.otpCode.value.length >= 6
                        ? controller.verifyOtpCodeFunc
                        : null,
                    isLoading:
                        controller.verifyOtpResponse.value.status ==
                        Status.loading,
                  ),
                ),
                SizedBox(height: 24.h),
