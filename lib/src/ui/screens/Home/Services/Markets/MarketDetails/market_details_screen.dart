...
import 'market_details_controller.dart';

class MarketDetailsScreen extends GetView<MarketDetailsController> {
          ...
          () => controller.isLoading.value
              ...
              : CustomScrollView(
                  slivers: [
                    ...
                    // ── 3. أزرار التبويبات (Category Tabs) ──
                    ...
                    SliverToBoxAdapter(
                      child: Padding(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            // 1. نبذة عن المركز / المكان
                            _buildAboutSection(theme),
                            SizedBox(height: 24.h),

                            // 2. المنتجات المتاحة مع التسعير بالريال القطري (ر.ق)
        ...
        Positioned(
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: controller.marketStats.map((stat) {
                return Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Icon(
  ...
  Widget _buildAboutSection(ThemeData theme) {
    ...
    return Column(
      ...
      children: [
        ...
        Column(
          children: controller.marketHighlights.map((highlight) {
            return Padding(
              padding: EdgeInsets.only(bottom: 6.h),
              child: Row(
                children: [
                  Icon(Iconsax.crown, color: cs.primary, size: 16.sp),
                  SizedBox(width: 8.w),
                  Expanded(
                    child: Text(
                      highlight,
  ...
  // ─────────────────────────────────────────────
  //  2. قسم: المنتجات المتاحة والتسعير (ر.ق)
  // ─────────────────────────────────────────────
  Widget _buildProductsSection(ThemeData theme) {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildSectionHeader('المنتجات المتاحة (ر.ق)', theme),
        SizedBox(height: 12.h),
        ListView.builder(
          shrinkWrap: true,
