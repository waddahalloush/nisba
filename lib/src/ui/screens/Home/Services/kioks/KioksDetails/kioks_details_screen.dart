...
import 'kioks_details_controller.dart';

class KioksDetailsScreen extends GetView<KioksDetailsController> {
  const KioksDetailsScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        // ── زر "شراء الآن" المثبت بأسفل الشاشة ──
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            // 2. الخدمات والمنيو المتاح مع التسعير بالريال القطري (ر.ق)
                            _buildServicesSection(theme),
                            SizedBox(height: 24.h),

                            // 3. ساعات العمل والتقييم التفصيلي من 5
      ...
      children: [
        ...
        Container(
          ...
          child: Stack(
            fit: StackFit.expand,
            children: [
              // تدرج لوني لإبراز النصوص الأفقية
              DecoratedBox(
                decoration: BoxDecoration(
        ...
        Positioned(
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: controller.kioskStats.map((stat) {
                return Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Icon(
  ...
  Widget _buildAboutSection(ThemeData theme) {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildSectionHeader('نبذة عن الكشك', theme),
        SizedBox(height: 8.h),
        Text(
        ...
        Column(
          children: controller.kioskHighlights.map((highlight) {
            return Padding(
              padding: EdgeInsets.only(bottom: 6.h),
              child: Row(
                children: [
                  Icon(Iconsax.coffee, color: cs.primary, size: 16.sp),
                  SizedBox(width: 8.w),
                  Expanded(
                    child: Text(
                      highlight,
  ...
  // ─────────────────────────────────────────────
  //  2. قسم: الخدمات والمشروبات المتاحة والتسعير (ر.ق)
  // ─────────────────────────────────────────────
  Widget _buildServicesSection(ThemeData theme) {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildSectionHeader('المنيو والخدمات (ر.ق)', theme),
        SizedBox(height: 12.h),
        ListView.builder(
          shrinkWrap: true,
  ...
  // ─────────────────────────────────────────────
  //  3. قسم: ساعات العمل والتقييم التفصيلي
  // ─────────────────────────────────────────────
  Widget _buildWorkingHoursAndRatingSection(ThemeData theme) {
    ...
    return Column(
      ...
      children: [
        ...
        // كارد ساعات العمل والتقييم من 5
        Container(
          ...
          child: Column(
            children: [
              ...
              Row(
                children: [
                  Icon(Iconsax.clock, color: cs.primary, size: 20.sp),
                  SizedBox(width: 10.w),
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
