...
class OrderChatScreen extends GetView<OrderChatController> {
      ...
      children: [
        Flexible(
          child: Container(
            ...
            decoration: BoxDecoration(
              color: isMine ? cs.primary.withValues(alpha: 0.08) : cs.primary,
            ...
            child: Column(
              ...
              children: [
                Text(
                  ...
                  style: TextStyle(
                    fontSize: 13.sp,
                    color: isMine ? cs.onSurface : cs.onPrimary,
                    height: 1.5,
                  ),
                ),
