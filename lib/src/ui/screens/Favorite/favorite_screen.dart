      ...
      () => ListView.separated(
        ...
        itemBuilder: (context, index) {
          return _FavoriteCard(
            item: controller.currentItems[index],
            onToggleLike: () => controller.toggleLike(index),
            onOpen: () => controller.openItem(controller.currentItems[index]),
          );
        },
      ),
    );
...
class _FavoriteCard extends StatelessWidget {
  ...
  const _FavoriteCard({required this.item, this.onToggleLike, this.onOpen});
                ...
                child: item.imageUrl.startsWith('http')
                    ? Image.network(
                        ...
                        errorBuilder: (_, __, ___) =>
                            Icon(Iconsax.shop, color: cs.primary),
                      )
                    : Image.asset(
                        item.imageUrl,
                        fit: BoxFit.cover,
